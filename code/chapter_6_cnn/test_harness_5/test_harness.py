...
# start_keras_models
model_0 = Sequential()
model_0.add(Conv2D(32, (3, 3), activation='relu', input_shape=(size, size, 1)))
...
model_1 = Sequential()
model_1.add(Conv2D(32, (3, 3), activation='relu', input_shape=(size, size, 1)))
...
names = [
    'c32-c64-do6-2mp2-do6-d-do6-d',
    'c32-c64-do3-2mp2-do5-d-do7-d',
...
fig.savefig(file1, dpi=2000, bbox_inches='tight')
...
plt.legend(names_2, bbox_to_anchor=(1.04,0.5), loc='center left')
fig.savefig(file2, dpi=2000, bbox_inches='tight')
# end_tests
