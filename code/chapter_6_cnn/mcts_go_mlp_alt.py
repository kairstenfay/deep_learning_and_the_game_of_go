...
model = Sequential()
model.add(Dense(81, activation='sigmoid', input_shape=(board_size,)))
...
print('Training test loss:', score1[0])
print('Training test accuracy:', score1[1])
print('Validation test loss:', score2[0])
print('Validation test accuracy:', score2[1])
